...
class MilvusStoreWithClient:
    ...
    def hybrid_search(self,        
        ...
        answer = []
        for an in res[0]:
            answer.append({"SCHEMA_NAME":an.entity.get('schema_name'),"TABLE_NAME":an.entity.get('table_name'),"TABLE_SCHEMA":an.entity.get("schema"),"IDS OF TABLES THAT ARE RELATED WITH GIVEN TABLE":an.entity.get('neighbours'), "TABLE CONSTRAINTS":an.entity.get('constraints')})
